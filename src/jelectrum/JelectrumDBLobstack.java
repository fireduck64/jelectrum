    ...
    public synchronized void open()
    {
        ...
        try
        {
          ...
          new FreeSpaceWatcher(path, jelly, min_space).start();
            ...
            block_store_map = new LobstackMap<Sha256Hash, StoredBlock>(openStack("block_store_map"),ConversionMode.OBJECT);
            special_block_store_map = new LobstackMap<String, StoredBlock>(special_block_store_map_stack,ConversionMode.OBJECT);
            block_map = new LobstackMap<Sha256Hash, SerializedBlock>(openStack("block_map"),ConversionMode.OBJECT);
            ...
            header_chunk_map = new LobstackMap<Integer, String>(openStack("header_chunk_map"),ConversionMode.STRING);
            utxo_trie_map = new LobstackMap<String, UtxoTrieNode>(openStack("utxo_trie_map"),ConversionMode.OBJECT);
